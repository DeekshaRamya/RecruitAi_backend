    ...
    mock_scenarios = [
        {
            ...
            "expectedAnswer": "SELECT TOP 5 * FROM HumanResources.Employee;",
            "correctAnswer": "SELECT TOP 5 * FROM HumanResources.Employee;",
        ...
        },
        {
            ...
            "candidateTask": "Write SELECT query",
            "expectedAnswer": "SELECT TOP 5 * FROM Sales.SalesOrderHeader;",
            "correctAnswer": "SELECT TOP 5 * FROM Sales.SalesOrderHeader;",
            "starterCode": "-- Write query",
            "starter_code": "-- Write query",
            "evaluationCriteria": "Valid syntax",
